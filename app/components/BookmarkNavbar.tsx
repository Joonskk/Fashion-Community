...
const Navbar = () => {
    ...
    const navMenu = [
        { href: "/bookmarkTab/bookmark", label: "북마크", key: 1 },
        { href: "/bookmarkTab/likes", label: "좋아요", key: 2 }
    ]
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 max-w-[750px] mx-auto opacity-95 bg-white text-xl font-bold px-7 border-x border-x-gray-200 border-b border-b-gray-200">
            <div className="my-4 flex justify-between items-center">
                ...
                <Link href="/"><Image src="/icons/Notification.png" width={25} height={25} alt="Notification Icon" /></Link>
            </div>
